            ...
            {data.length > 0 ? (
                <ul className="reclamacoes-list">
                    {data.map((item) => {
                        ...
                        return (
                            <li key={item.id} className="reclamacao-item">
                                <Link to={`/reclamacao/${item.id}`} className="reclamacao-link">
                                    <p className="reclamacao-title">{item.title}</p>
                                    <p className="reclamacao-description">{item.description}</p>
                ...
                !error && <p>Você não tem nenhuma reclamação.</p>
            )}
        </div>
